...
vue数据双向绑定是通过数据劫持结合`发布者-订阅者`模式的方式来实现的，那么vue是如果进行数据劫持的，我们可以先来看一下通过控制台输出一个定义在vue初始化数据上的对象：
...
![](./media/80a7ffeb4dff217e076c280f2580441c_690x328.png)
...
![](./media/d34ff3d7d519d6cadedaa9ba56c149f4_536x224.png)

说明vue确实是通过这种方法来进行数据劫持的。
...
![](./media/05994e197a5ef3664311323b1dc683cc_493x168.jpg =400x150)
...
![](./media/46abbd6de819d0ac6dbc75c8d5a9b89f_581x399.jpg)
...
![](./media/c341bfa690056d1a76e7565446c33cbe_785x578.png)
...
![](./media/526b29f107df8543a307d5de31864b93_600x449.gif)